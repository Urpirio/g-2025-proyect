...
export default function Section1Home() {
  return (
    <section className="flex relative py-20 md:py-0">
        ...
        lg:mask-l-from-30% 
        lg:mask-l-to-60%  w-dvw lg:h-dvh hidden md:flex justify-end items-start">
            <Image className="   object-contain" src={imgFamily} alt=""/>
        </div>
        <div className=" md:absolute boder w-full md:py-20 lg:py-20 lg:h-[80%] flex flex-col justify-center gap-5 px-10 ">

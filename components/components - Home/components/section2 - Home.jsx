...
export default function Section2Home() {
  return (
    <section className="flex flex-wrap py-10 md:py-20">
        <div className=" h-[100%] w-[100%] px-10 md:w-[50%] flex justify-end">
            <Image className="object-cover" src={ImgSection2} alt="ImgSection"/>
        </div>
        <div className=" w-[100%] md:w-[50%] flex justify-end  p-10">

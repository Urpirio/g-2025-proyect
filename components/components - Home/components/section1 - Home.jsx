...
export default function Section1Home() {
  return (
    <section className="flex relative py-5 md:py-0">
        <div className=" 
        md:mask-l-from-20% 
        md:mask-l-to-60% 
        ...
        <div className=" md:absolute z-20 boder w-full md:py-20 lg:py-20 lg:h-[80%] flex flex-col justify-center gap-5 px-10 ">
            ...
            <div className="flex justify-center md:justify-start">
                <button className="border px-5 md:px-15 py-3 bg-fblue rounded-2xl text-xl md:text-2xl font-semibold text-white">Registrar</button>
            </div>
        </div>
    </section>
  )
